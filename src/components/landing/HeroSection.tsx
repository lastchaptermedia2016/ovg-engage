    ...
    <section className="relative overflow-hidden pt-32 pb-20 md:pt-40 md:pb-32">
      ...
      <div className="container relative">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          {/* Left: Copy - now takes full width since mockup is removed */}
          <motion.div
          ...
          >
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5 text-sm text-primary mx-auto lg:mx-0">
            ...
            <div className="mt-10 flex items-center gap-8 text-sm text-muted-foreground justify-center lg:justify-start">
